        ...
        <div v-if="windowWidth <= 768" class="flex flex-col justify-center my-0">
          ...
          >
            <div class="text-center flex flex-col justify-center items-center pt-3 pb-4 px-4 sm:px-8">
              ...
              <div
                class="w-full text-accent flex items-center py-0 pl-0"
              ...
              >
                ...
                <span class="text-secondary ml-2">{{ rating.date }}</span>
                <div class="flex-grow"></div>
                <span @click="setSearch(rating.user)" class="cursor-pointer">{{ rating.user }}</span>
              </div>
            </div>
            <hr class="border-primary px-0" />
          </div>
        </div>
          ...
          <div v-for="rating in filteredRatings" :key="rating.id" class="w-full">
            ...
            >
              <div class="text-center flex flex-col justify-center items-center w-full">
                ...
                >{{ rating.platform }}</div>
                <div
                  class="absolute bottom-0 right-0 text-xl text-secondary font-bold font-italic text-center pa-0"
                >{{ rating.date }}</div>
                <div
