        ...
        <v-card-actions style="width: 100%;">
          <v-row class="justify-center">
            ...
            <v-col cols="12" class="text-center" v-if="!userAuth">
              ...
              >
                <v-icon size="25" left>mdi-plus</v-icon>&nbsp;Rate This Show
              </v-btn>
              <v-btn
                large
                @click="dialog=false"
                ...
                style="background-color: rgba(120, 47, 64, 0.5);"
              >
                <v-icon size="25" left>mdi-plus</v-icon>&nbsp;See The Ratings
              </v-btn>
            </v-col>
            ...
            <v-col cols="12" class="text-center" v-else>
              ...
              <v-btn
                ...
                style="background-color: rgba(120, 47, 64, 0.5);"
              >
                <v-icon size="25" left>mdi-account-cog</v-icon>&nbsp;See The Ratings
              </v-btn>
            </v-col>
          </v-row>
        </v-card-actions>
